<template>
    <el-tabs type="border-card" class="box">
        ...
        <el-tab-pane label="收藏量top20">
            <div style="height: 800px">
                <h2 style="margin-top: 20px;
           text-align: center;color: #c6a854;font-size: 30px">
                    收藏量top20
                </h2>
                <div id="sc" style=" width: 1800px;height:500px;margin-top: 200px" ref="map1"/>
            </div>
        </el-tab-pane>
...
<script>
    ...
    export default {
        ...
        methods: {
            data() {
                axios.post("api/echarts3/").then(res => {
            ...
            data2() {
                axios.post("api/echarts3/").then(res => {
                    const chart = document.getElementById('sc')
                    const myCharts = echarts.init(chart);
                    const option = {
                        tooltip: {
                            // 鼠标停放时提示数据
